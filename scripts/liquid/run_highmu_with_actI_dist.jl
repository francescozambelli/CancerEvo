# scripts/liquid/run_highmu_with_actI_dist.jl
#
# Runs the liquid-tumor simulation inline until a Tumor outcome is found whose
...
function run_until_highmu()
    ...
    while true
        ...
        for k in 1:n_steps
            substitute_liquid!(tiss, N_CHR, misseg_type)
        ...
        # ---- Save ----
        out_dir = joinpath(dirname(dirname(@__DIR__)), "data", "simulations_liquid", "highmu_actI_dist")
        mkpath(out_dir)
