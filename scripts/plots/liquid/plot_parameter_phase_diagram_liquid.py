"""
plot_parameter_phase_diagram_liquid.py
--------------------------------------
Plot a 2D phase diagram (heatmap) showing the fraction of liquid-tumor simulations
that end with a tumor present (either exceeding the mass limit 'Tumor_Max' or
persisting until the end of steps 'Done') as a function of the parameter grid (dmu, dr).

Outputs
-------
outputs/figures/parameter_phase_diagram_liquid.png
outputs/figures/parameter_phase_diagram_liquid.svg
"""
...
def plot_heatmap():
    ...
    csv_path = project_root / "data" / "parameter_phase_diagram_results_liquid.csv"
    output_dir = project_root / "outputs" / "figures" / "liquid"
    output_dir.mkdir(parents=True, exist_ok=True)
    root_dir = output_dir.parent
    output_path_png = output_dir / "parameter_phase_diagram_liquid.png"
    output_path_svg = output_dir / "parameter_phase_diagram_liquid.svg"
    output_path_png_root = root_dir / "parameter_phase_diagram_liquid.png"
    output_path_svg_root = root_dir / "parameter_phase_diagram_liquid.svg"
