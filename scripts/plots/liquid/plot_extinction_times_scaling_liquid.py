...
def plot_combined():
    ...
    output_dir = f"../../../outputs/figures/phase_transition_liquid_init{args.init_mass_pct}_limit{args.limit_pct}"
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
        
    save_publication_figure(fig, f"extinction_time_scaling_combined_liquid_init{args.init_mass_pct}_limit{args.limit_pct}", output_dir=output_dir)
