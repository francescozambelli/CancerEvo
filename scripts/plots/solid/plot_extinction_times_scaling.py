...
def plot_combined():
    ...
    if vals_dr is not None:
        ...
        # Separate branches (excluding the peak where dist=0)
        sub_idx = (vals_dr_scaled < peak_val) & (dist_dr > 0)
        sup_idx = (vals_dr_scaled > peak_val) & (dist_dr > 0)
