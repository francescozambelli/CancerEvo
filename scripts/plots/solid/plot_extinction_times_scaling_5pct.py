...
def load_data(sweep_type):
    data_dir = f"../../../data/phase_transition_5pct/{sweep_type}"
...
def plot_combined():
    ...
    output_dir = "../../../outputs/figures/phase_transition_5pct"
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
        
    save_publication_figure(fig, "extinction_time_scaling_combined_5pct", output_dir=output_dir)
