...
def plot_combined():
    ...
    # --- DMU PLOT ---
    vals_dmu, data_time_dmu, means_dmu, indiv_v_dmu, indiv_t_dmu = load_data("dmu", v_min=13e-3, v_max=21e-3)
    ...
    # --- DR PLOT ---
    vals_dr, data_time_dr, means_dr, indiv_v_dr, indiv_t_dr = load_data("dr", v_min=1e-3, v_max=7e-3)
