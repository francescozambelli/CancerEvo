...
def plot_combined(fontsize_labels=25, fontsize_ticks=20):
    ...
    if vals_dmu is not None:
        ...
        plot_mean_panel(axes_mean[0], vals_dmu, 16.9, means_dmu, r"\Delta \mu", "#08519c")
        ...
        plot_mean_panel(ax_mean_s, vals_dmu, 16.9, means_dmu, r"\Delta \mu", "#08519c", fontsize_labels=fontsize_labels, fontsize_ticks=fontsize_ticks)
        fig_mean_s.tight_layout()
        save_publication_figure(fig_mean_s, "solid_extinction_time_mean_dmu", output_dir=output_dir)
    ...
    if vals_dr is not None:
        ...
        fig_mean_s.tight_layout()
        save_publication_figure(fig_mean_s, "solid_extinction_time_mean_dr", output_dir=output_dir)
        plt.close(fig_mean_s)
    ...
    save_publication_figure(fig_mean, "extinction_time_mean_combined", output_dir=output_dir)
    plt.close(fig_mean)
