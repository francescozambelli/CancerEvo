# src/simulation_spatial.jl
#
# Spatial snapshot variant of the solid-tumor simulation.
...
# ---------------------------------------------------------------------------
"""
    simulation_spatial(tiss, n_chr_init, n_steps, n_snapshots, bar, limit, lower_limit, misseg_type)

Run the solid-tumor simulation and record `n_snapshots` spatially-resolved
lattice frames distributed uniformly across the run.
"""
function simulation_spatial(tiss::OptimizedTissue, n_chr_init::Int,
    ...
    @showprogress enabled=bar for k in 1:n_steps
        ...
        # ---- Aggregate metrics (identical to simulation_optimized) ----
